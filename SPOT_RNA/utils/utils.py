...
def prob_to_secondary_structure(ensemble_outputs, label_mask, seq, name, args, base_path, input_file):
    ...
    np.save(os.path.join(output_path, input_file.replace('.ct', '_raw_predict_.npy')), y_pred)
